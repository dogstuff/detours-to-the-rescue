...
#define DTTR_CONFIG_UI_PANEL_PADDING_X DTTR_IMGUI_PANEL_PADDING_X
#define DTTR_CONFIG_UI_PANEL_PADDING_Y DTTR_IMGUI_PANEL_PADDING_Y
#define DTTR_CONFIG_UI_ITEM_SPACING_X DTTR_IMGUI_ITEM_SPACING_X
#define DTTR_CONFIG_UI_ITEM_SPACING_Y DTTR_IMGUI_ITEM_SPACING_Y
...
#define DTTR_CONFIG_UI_TAB_ACCENT_COLOR DTTR_IMGUI_COLOR_TAB_ACCENT
#define DTTR_CONFIG_UI_TAB_BG DTTR_IMGUI_COLOR_TAB_BG
#define DTTR_CONFIG_UI_SELECTED_TAB_BG DTTR_IMGUI_COLOR_TAB_SELECTED_BG
#define DTTR_CONFIG_UI_SELECTED_TAB_TEXT_COLOR ((ImVec4_c){0.96f, 0.96f, 0.94f, 1.0f})
#define DTTR_CONFIG_UI_TAB_HOVERED_BG DTTR_IMGUI_COLOR_TAB_HOVERED_BG
#define DTTR_CONFIG_UI_TOP_BAR_BG DTTR_IMGUI_COLOR_TOP_BAR_BG
...
#define DTTR_CONFIG_UI_BUTTON_HOVERED_BG DTTR_IMGUI_COLOR_ACCENT_BUTTON_BG_HOVERED
#define DTTR_CONFIG_UI_BUTTON_ACTIVE_BG DTTR_IMGUI_COLOR_ACCENT_BUTTON_BG_ACTIVE
#define DTTR_CONFIG_UI_BORDER_COLOR DTTR_IMGUI_COLOR_BORDER
#define DTTR_CONFIG_UI_TABLE_BORDER_COLOR DTTR_IMGUI_COLOR_TABLE_BORDER
#define DTTR_CONFIG_UI_TABLE_HEADER_BG DTTR_IMGUI_COLOR_TABLE_HEADER_BG
#define DTTR_CONFIG_UI_SEPARATOR_COLOR DTTR_IMGUI_COLOR_SEPARATOR
#define DTTR_CONFIG_UI_STATUS_TEXT_COLOR ((ImVec4_c){1.0f, 0.82f, 0.25f, 1.0f})
#define DTTR_CONFIG_UI_HINT_TEXT_COLOR DTTR_IMGUI_COLOR_HINT_TEXT
