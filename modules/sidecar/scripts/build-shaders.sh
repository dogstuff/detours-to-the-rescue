...
# Maps shader filename stems to shadercross stages before compiling SDL GPU blobs.
...
for glsl in "$src_dir"/*.glsl; do
  ...
  if ! stage="$(shader_stage_for_stem "$stem")"; then
    echo "Unknown shader stage for $glsl; expected .vert.glsl, .frag.glsl, or .comp.glsl" >&2
    exit 1
  fi
...
{
  echo "// Auto-generated by modules/sidecar/scripts/build-shaders.sh. Do not edit."
