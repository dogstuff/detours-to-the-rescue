...
s_d3d7_enum_devices(DTTR_Graphics_COM_Direct3D7 *self, void *cb, void *ctx) {
...
static HRESULT __stdcall
s_d3d7_createdevice(DTTR_Graphics_COM_Direct3D7 *self, void *guid, void *surf, void **dev) {
...
static HRESULT __stdcall
s_d3d7_enumzbufferformats(DTTR_Graphics_COM_Direct3D7 *self, void *guid, void *cb, void *ctx) {
