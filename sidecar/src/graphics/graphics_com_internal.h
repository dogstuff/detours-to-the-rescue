...
typedef struct DTTR_Graphics_COM_Direct3DDevice7_VT {
	HRESULT(__stdcall *QueryInterface)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, void *riid, void **ppv
	);																				  // 0x00
	...
	HRESULT(__stdcall *EnumTextureFormats)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, void *cb, void *ctx
	);																					  // 0x10
	...
	HRESULT(__stdcall *SetRenderTarget)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, void *surf, DWORD f
	); // 0x20
	HRESULT(__stdcall *GetRenderTarget)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, void **surf
	); // 0x24
	...
	HRESULT(__stdcall *SetTransform)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD m_type, void *mat
	); // 0x2C
	...
	HRESULT(__stdcall *MultiplyTransform)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD m_type, void *m
	);																					 // 0x38
	...
	HRESULT(__stdcall *SetLight)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD idx, void *light
	); // 0x48
	HRESULT(__stdcall *GetLight)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD idx, void *light
	); // 0x4C
	HRESULT(__stdcall *SetRenderState)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD state, DWORD val
	); // 0x50
	HRESULT(__stdcall *GetRenderState)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD state, DWORD *v
	);																			  // 0x54
	HRESULT(__stdcall *BeginStateBlock)(DTTR_Graphics_COM_Direct3DDevice7 *self); // 0x58
	HRESULT(__stdcall *EndStateBlock)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD *block
	);																				 // 0x5C
	...
	HRESULT(__stdcall *SetClipStatus)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, void *status
	); // 0x6C
	...
	HRESULT(__stdcall *GetTexture)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD stage, void **tex
	); // 0x88
	...
	HRESULT(__stdcall *ValidateDevice)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD *passes
	); // 0x98
	...
	HRESULT(__stdcall *CreateStateBlock)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD t, DWORD *blk
	); // 0xA8
	...
	HRESULT(__stdcall *LightEnable)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD idx, BOOL enable
	); // 0xB0
	HRESULT(__stdcall *GetLightEnable)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD idx, BOOL *en
	); // 0xB4
	HRESULT(__stdcall *SetClipPlane)(
		DTTR_Graphics_COM_Direct3DDevice7 *self, DWORD idx, float *plane
	); // 0xB8
...
typedef struct DTTR_Graphics_COM_DirectDraw7_VT {
	HRESULT(__stdcall *QueryInterface)(
		DTTR_Graphics_COM_DirectDraw7 *self, void *riid, void **ppv
	);																  // 0x00
	...
	HRESULT(__stdcall *DuplicateSurface)(
		DTTR_Graphics_COM_DirectDraw7 *self, void *src, void **dst
	); // 0x1C
	...
	HRESULT(__stdcall *SetCooperativeLevel)(
		DTTR_Graphics_COM_DirectDraw7 *self, HWND hwnd, DWORD f
	); // 0x50
	...
	HRESULT(__stdcall *WaitForVerticalBlank)(
		DTTR_Graphics_COM_DirectDraw7 *self, DWORD f, HANDLE evt
	); // 0x58
	...
	HRESULT(__stdcall *GetSurfaceFromDC)(
		DTTR_Graphics_COM_DirectDraw7 *self, HDC dc, void **surf
	);																			   // 0x60
	...
	HRESULT(__stdcall *GetDeviceIdentifier)(
		DTTR_Graphics_COM_DirectDraw7 *self, void *id, DWORD f
	); // 0x6C
	HRESULT(__stdcall *StartModeTest)(
		DTTR_Graphics_COM_DirectDraw7 *self, void *modes, DWORD n, DWORD f
	); // 0x70
	HRESULT(__stdcall *EvaluateMode)(
		DTTR_Graphics_COM_DirectDraw7 *self, DWORD f, DWORD *timeout
	); // 0x74
...
typedef struct DTTR_Graphics_COM_Direct3D7_VT {
	...
	HRESULT(__stdcall *CreateDevice)(
		DTTR_Graphics_COM_Direct3D7 *self, void *guid, void *surf, void **dev
	);
	HRESULT(__stdcall *CreateVertexBuffer)(
		DTTR_Graphics_COM_Direct3D7 *self, void *desc, void **vb, DWORD f
	);
	HRESULT(__stdcall *EnumZBufferFormats)(
		DTTR_Graphics_COM_Direct3D7 *self, void *guid, void *cb, void *ctx
	);
...
typedef struct DTTR_Graphics_COM_Direct3DTexture2_VT {
	HRESULT(__stdcall *QueryInterface)(
		DTTR_Graphics_COM_Direct3DTexture2 *self, void *riid, void **ppv
	);
	...
	HRESULT(__stdcall *GetHandle)(
		DTTR_Graphics_COM_Direct3DTexture2 *self, void *m_device, DWORD *handle
	);
	HRESULT(__stdcall *PaletteChanged)(
		DTTR_Graphics_COM_Direct3DTexture2 *self, DWORD start, DWORD count
	);
...
typedef struct DTTR_Graphics_COM_DirectDrawSurface7_VT {
	HRESULT(__stdcall *QueryInterface)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *riid, void **ppv
	);
	...
	HRESULT(__stdcall *BltBatch)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *batch, DWORD count, DWORD m_flags
	);
	...
	HRESULT(__stdcall *DeleteAttachedSurface)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, DWORD m_flags, void *surf
	);
	HRESULT(__stdcall *EnumAttachedSurfaces)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *ctx, void *cb
	);
	...
	HRESULT(__stdcall *Flip)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *target, DWORD m_flags
	);
	...
	HRESULT(__stdcall *GetColorKey)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, DWORD m_flags, void *colorKey
	);
	...
	HRESULT(__stdcall *GetOverlayPosition)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, LONG *x, LONG *y
	);
	...
	HRESULT(__stdcall *Initialize)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *dd, void *desc
	);
	...
	HRESULT(__stdcall *UpdateOverlayDisplay)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, DWORD m_flags
	);
	HRESULT(__stdcall *UpdateOverlayZOrder)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, DWORD m_flags, void *refSurf
	);
	...
	HRESULT(__stdcall *SetSurfaceDesc)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *desc, DWORD m_flags
	);
	...
	HRESULT(__stdcall *GetPrivateData)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, void *tag, void *data, DWORD *size
	);
	HRESULT(__stdcall *FreePrivateData)(DTTR_Graphics_COM_DirectDrawSurface7 *self, void *tag);
	HRESULT(__stdcall *GetUniquenessValue)(
		DTTR_Graphics_COM_DirectDrawSurface7 *self, DWORD *value
	);
